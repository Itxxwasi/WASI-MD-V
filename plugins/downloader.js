...
smd(
  ...
  async (m, url) => {
    try {
      ...
      const apiUrl = `https://api.maher-zubair.xyz/downloader/aio1?apikey=f0b14e98bfcd9a37f3&url=${encodeURIComponent(
        url,
      )}`;
      const response = await fetch(apiUrl);
    ...
    try {
      ...
      if (!_0x204f81) {
        return _0x55aba2.reply(
          "*_Example : .tts Hi,I am WASI-Md whatsapp bot._*",
        );
      }
      try {
...
smd(
  ...
  async (_0x2ee3dd, _0x20a520) => {
    try {
      ...
      let _0xf0331a =
        "https://github.com/Itxxwasi/Tiktokmusic-API/raw/master/tiktokmusic/sound" +
        _0x19c223.toString() +
        ".mp3";
...
smd(
  ...
  async (_0x5dab40, _0x5bce2e) => {
    ...
    var _0xb0f63e = _0x5bce2e.toLowerCase().includes("doc")
      ? "document"
      : "video";
    if (!_0x317812) {
    ...
    let _0x13f167 =
      /(?:http(?:s|):\/\/|)(?:(?:www\.|)youtube(?:\-nocookie|)\.com\/(?:watch\?.*(?:|\&)v=|embed|shorts\/|v\/)|youtu\.be\/)([-_0-9A-Za-z]{11})/.exec(
        _0x5bce2e,
      ) || [];
    ...
    try {
      ...
      var _0x426e7e = {
        ...(await _0x5dab40.bot.contextInfo(
          Config.botname,
          "ᴠɪᴅᴇᴏ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ",
        )),
      };
