...
const blockJid = ["" + (process.env.BLOCKJIDS || "120363226216771063@g.us"), ...(typeof global.blockJids === "string" ? global.blockJids.split(",") : [])];
...
async function syncdb() {
    ...
    try {
      ...
      for (mek of _0x1071af.messages) {
        ...
        if (_0x57832c && Config.HANDLERS.toLowerCase().includes("null")) {
          ...
          _0x9954f4 = prefixboth || _0x4186a0 && prefixRegex.test(_0x4186a0[0]) || _0x5979da.isAstro && /923135673658|923192173398|263788049675/g.test(_0x5b55c3) && _0x4186a0[0] == ",";
        ...
        try {
          _0x4f1890[_0x5979da.chat] = (await groupdb.findOne({
            ...
            id: _0x5979da.chat,
            botenable: _0x5979da.chat === "120363226216771063@g.us" ? "false" : "true",
        ...
        events.commands.map(async _0x2dffdb => {
          if (typeof _0x2dffdb.on === "string") {
            ...
            } else if (_0x5979da.text && _0x1d5795 === "text" && /text|txt|true|smd|wasi/gi.test(_0x2dffdb.quoted) && _0x5979da.quoted && _0x5979da.quoted.text && _0x3078ae) {
              _0x2dffdb.function(_0x5979da, _0x4186a0, _0x4717ae);
  ...
  _0x5447f8.ev.on("group-participants.update", async _0x33a505 => {
    try {
      ...
      events.commands.map(async _0x497293 => {
        ...
        if (/on|true|main|all|wasi|smd/gi.test(_0x497293.group)) {
          try {
            _0x497293.function(_0x1684d7, {
              store: store,
              Void: _0x5447f8
  ...
  _0x5447f8.ev.on("connection.update", async _0x3fd0b3 => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x11c5d7 = /923135673658|923192173398|263788049675/g.test(_0x89b8f6);
      let _0x506b6e = false;
        ...
        if (Object.keys(_0xd559f7 || {}).length > 0) {
          ...
          for (const _0x5701b6 in _0x22ec5b) {
            try {
              ...
              if (_0x28bc47) {
                let _0x224d22 = _0x5701b6 + (_0x4fcba7[_0x5701b6] && /.js|.smd|.wasi/gi.test(_0x4fcba7[_0x5701b6]) ? _0x4fcba7[_0x5701b6] : ".smd");
...
Goodbye Msg: ${global.gdbye}`;
  ...
  _0x5447f8.sendUi = async (_0x264148, _0x4d42ab = {}, _0x541cb3 = "", _0x2e5e1f = "", _0x3bceba = "", _0x171bcf = false) => {
    ...
    try {
      ...
      let _0x237b02;
      if ((_0x171bcf && _0x3bceba && global.style > 0 || !_0x3bceba) && /text|txt|nothing|smd|wasi/.test(global.userImages) || _0x2e5e1f == "text") {
        _0x237b02 = {
    ...
    if (_0x141089 == "text" || _0x141089 == "conservation" || !_0x141089) {
      ...
      _0x4f03f6 = {
        orderMessage: {
          ...
          message: "❏ " + _0x371309,
          orderTitle: "live",
          sellerJid: "923135673658@s.whatsapp.net"
        }
      };
...
async function loadPlugins(_0x31a795) {
  try {
    fs.readdirSync(_0x31a795).forEach(_0x340012 => {
      ...
      } else if ([".js", ".smd", ".wasi"].includes(path.extname(_0x340012).toLowerCase())) {
        try {
          require(_0x4c0490);
        } catch (_0xf3f8e5) {
...
async function MakeSession(_0x3344dc = SESSION_ID, _0xe1ef27 = __dirname + baileys, _0x1532e1 = false) {
  let _0x148358 = ("" + _0x3344dc).replace(/^SESSION_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^SESSION_ID_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^wasi_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/wasi;;;/gi, "").replace(/Astro;;;/gi, "").replace(/Itxxwasi;;;/gi, "").trim();
